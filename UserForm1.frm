...
If Me.domnul_box Then
    ...
    document_changes.change_client_code (myClient.client_code)
    document_changes.change_name_domnul myClient.first_name, myClient.last_name
    


ElseIf Me.doamna_box Then
...
ElseIf Me.firma_box Then

    'myClient.InitializeWithValues Trim(Me.codclient_textbox.Value), Trim(Me.prenume_textbox)
    MsgBox "Modul Firma inca este in lucru."
